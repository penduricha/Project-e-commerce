...
.dropdown-toggle::after {
  content: ''; /* Đảm bảo có mũi tên */
  display: inline-block; /* Hiển thị như một phần tử inline */
  border: solid; /* Tạo mũi tên */
  border-width: 0 2px 2px 0; /* Định dạng mũi tên */
  padding: 3px; /* Kích thước mũi tên */
